...
[CreateAssetMenu(fileName = "InputReader", menuName = "Game/Game Input Reader")]
public class GameInputReader : ScriptableObject, InGameInput.IGameplayActions, InGameInput.IDialoguesActions
{
	// Gameplay
